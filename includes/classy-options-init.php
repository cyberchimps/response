...
TEMPLATE_URL . '/images/social/thumbs/icons-default.png' ), 'default' => 'default' ) )
	...
	->section("Blog")
		->open_outersection()
			->section_order($themeslug."_blog_section_order", "Drag & Drop Blog Elements", array('options' => array("response_index" => "Post Page", "response_blog_slider" => "Feature Slider",  "response_callout_section" => "Callout Section"), "default" => 'response_index'))
		->close_outersection()
		...
		->subsection("Feature Slider")
			->upload($themeslug."_blog_slide_one", "Slide One Image", array('default' => array('url' => TEMPLATE_URL . '/images/responseslider.jpg')))
			->text($themeslug."_blog_slide_one_url", "Slide One Link", array('default' => 'http://cyberchimps.com'))
			->upload($themeslug."_blog_slide_two", "Slide Two", array('default' => array('url' => TEMPLATE_URL . '/images/responseslider.jpg')))
			->text($themeslug."_blog_slide_two_url", "Slide Two Link", array('default' => 'http://cyberchimps.com'))
			->upload($themeslug."_blog_slide_three", "Slide Three", array('default' => array('url' => TEMPLATE_URL . '/images/responseslider.jpg')))
