...
if ( ! function_exists( 'optionsframework_mlu_init' ) ) {
	function optionsframework_mlu_init () {
		register_post_type( 'optionsframework', array(
			'labels' => array(
				'name' => __( 'Options Framework Internal Container', 'response' ),
			),
			'public' => true,
			'show_ui' => false,
...
if ( ! function_exists( 'optionsframework_mlu_js' ) ) {
	...
	function optionsframework_mlu_js () {
		...
		wp_register_script( 'of-medialibrary-uploader', CLASSY_OPTIONS_FRAMEWORK_URL .'js/of-medialibrary-uploader.js', array( 'jquery', 'thickbox' ) );
